...
class NodeManager:
    ...
    def extract_port_from_args(
        self, extra_args: list[str], option: str
    ) -> Optional[int]:
    ...
    def create_data_dir_for_daemon(
        ...
        """Create and configure data directory for a daemon.

        Args:
            data_dir_arg: Argument name for data directory option.
            default_args: List to append default arguments to.
            extra_args: User-provided extra arguments.
            tempdir: Base temporary directory.
            testname: Name of the test for directory naming.
        """
