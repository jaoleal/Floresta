...
mod tests {
    ...
    ///
    /// utxo_lock: is the lock value which can be either a height or a timestamp. Defines the creation time/height of the UTXO. Values > 500,000,000 will be considered a unix timestamp, otherwise a height.
    ///
